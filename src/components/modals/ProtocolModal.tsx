...
export const ProtocolModal = ({
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-md flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="protocol-modal-title">
            <div className="bg-slate-950 border border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl max-h-[85vh] overflow-y-auto relative">
                ...
                <div className="flex justify-between items-start mb-6 relative">
                    <div>
                        <h3 id="protocol-modal-title" className="text-2xl font-bold text-white">Evening Protocol</h3>
